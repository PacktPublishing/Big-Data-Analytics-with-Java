...
public class ScatterPlotChartGradeVsAmt extends ApplicationFrame {
	XYDataset inputData;
	JFreeChart chart;
	public static String APP_NAME = "SCATTER_PLOT_EXAMPLE";
	public static String APP_MASTER = "local";
	
	public ScatterPlotChartGradeVsAmt(String title) {
		super(title);
	...
	public static void main(String[] args) {
		ScatterPlotChartGradeVsAmt demo = new ScatterPlotChartGradeVsAmt ("Scatter Plot");
			demo.pack ();
...
//		   if(annualIncDbl > 100000) return null;
